...
export async function generateStaticParams() {
  const paths = getAllContentIds('speakers');
  return paths;
}

export default async function SpeakerPage({ params }: { params: { slug: string } }) {
  try {
    const speaker = await getContentData('speakers', params.slug);
